...
export async function GET(request: NextRequest) {
  try {
    ...
    const title = searchParams.get('title') || 'Real Estate Investment Opportunity'
    const location = searchParams.get('location') || 'Nigeria'
    const roi = searchParams.get('roi') || '15'
    ...
    return new ImageResponse(
      (
        ...
        >
          ...
          >
            Secure • Transparent • Profitable Real Estate Investment
          </div>
        </div>
      ),
      {
